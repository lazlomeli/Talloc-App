...
export const Dashboard = () => {
  ...
  const session_user = localStorage.getItem("talloc_username");
  ...
  useEffect(() => {
    taskAPI.getUserTasks(session_user, auth.config()).then((resp) => {
      setTasks(resp.data);
    });
  }, []);
  ...
  function logout() {
    console.log(`Logged out from ${session_user} session`);
